...
export class HeaderComponent implements OnInit {
  ...
  ngOnInit() {
    if (isPlatformBrowser(this.platformId)) {
      ...
      // Ativa tradução globalmente. Usamos afterNextRender em vez de rodar
      // aqui direto porque, no momento do ngOnInit, o próprio HTML do header
      // (e o resto da página) ainda não existe no DOM — então buscar
      // elementos por id/seletor nesse ponto sempre falhava silenciosamente.
      afterNextRender(() => {
  ...
  private readonly translations: Record<string, Record<string, string>> = {
    pt: {
      ...
      nav_a_plataforma: 'A Plataforma', nav_para_maes: 'Para Mães',
    ...
    en: {
      ...
      nav_a_plataforma: 'The Platform', nav_para_maes: 'For Mothers',
    ...
    es: {
      ...
      nav_a_plataforma: 'La Plataforma', nav_para_maes: 'Para Madres',
  ...
  /** Chamado pelo (click) de cada item do menu de idiomas no template. */
